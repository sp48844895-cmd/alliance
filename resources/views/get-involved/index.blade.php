...
@section('title', $metaTitle ?? 'Get Involved · ChhattisgarhABC')
@section('meta_description', $metaDescription ?? 'Four pathways to join the alliance — volunteer, intern, fellowship or organisation partner. Pick yours and register to support social and behavioural change communication.')
