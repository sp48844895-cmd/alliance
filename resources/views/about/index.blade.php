...
@section('title', $metaTitle ?? 'About the Alliance · ChhattisgarhABC')
@section('meta_description', $sections['meta']['meta_description'] ?? 'ChhattisgarhABC is an open, non-financial alliance of youth, professionals, civil society and government — co-creating Social & Behaviour Change Communication across Chhattisgarh, with a deep focus on PVTG villages.')
...
@if(!empty($sections['vision_mission']['html']))
{!! $sections['vision_mission']['html'] !!}
@else
...
@if(!empty($sections['approach']['html']))
...
@if(!empty($sections['voices']['html']))
{!! $sections['voices']['html'] !!}
@else
<div class="container-x">
...
@if(!empty($sections['partners']['html']))
