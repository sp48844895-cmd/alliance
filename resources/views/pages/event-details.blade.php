        ...
        <aside class="ed-sidebar">
          ...
          <div class="ed-panel ed-panel--accent">
            ...
            <div class="ed-action-stack">
              <a href="{{ $event['cta_link'] }}" class="ed-action-link" target="{{ $event['cta_link'] === route('contact') ? '_self' : '_blank' }}" rel="noreferrer">
                <b>{{ $event['cta_label'] }}</b>
        ...
        <div class="ed-related-grid">
          @foreach ($relatedEvents as $relatedEvent)
            <article class="ed-related-card">
              <a href="{{ route('events.show', $relatedEvent['slug']) }}" class="ed-related-link">
