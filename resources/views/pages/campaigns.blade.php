...
@if(!empty($pageSections['hero']['html']))
{!! $pageSections['hero']['html'] !!}
@else
...
@if(!empty($pageSections['filters']['html']))
{!! $pageSections['filters']['html'] !!}
@else
<div class="container-x">
...
@if(!empty($pageSections['grid']['html']))
{!! $pageSections['grid']['html'] !!}
@else
...
@if(!empty($pageSections['timelines']['html']))
{!! $pageSections['timelines']['html'] !!}
@else
<div class="container-x">
...
@if(!empty($pageSections['cta']['html']))
{!! $pageSections['cta']['html'] !!}
@else
<div class="container-x">
