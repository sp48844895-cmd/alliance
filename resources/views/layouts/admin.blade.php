...
@php
    $sections = [
        ...
        ['heading' => 'Content', 'links' => [
            ...
            ['route' => 'admin.home-slider.index', 'icon' => 'bi-sliders',          'label' => 'Home slider',    'wildcard' => 'admin.home-slider.*'],
            ['route' => 'admin.sbc-pool.index',   'icon' => 'bi-person-badge',     'label' => 'SBC pool', 'wildcard' => 'admin.sbc-pool.*'],
        ]],
        ['heading' => 'Learning', 'links' => [
            ['route' => 'admin.learning-main-cats.index', 'icon' => 'bi-bookmark-star', 'label' => 'Main categories', 'wildcard' => 'admin.learning-main-cats.*'],
            ['route' => 'admin.learning-sub-cats.index',  'icon' => 'bi-diagram-3',     'label' => 'Subcategories', 'wildcard' => 'admin.learning-sub-cats.*'],
        ...
        ['heading' => 'Community', 'links' => [
            ['route' => 'admin.memberships.index', 'icon' => 'bi-people',     'label' => 'Approved members',  'wildcard' => 'admin.memberships.*'],
