{{--
  Recursive tree node partial for the Learning Corner sidebar.
  Variables: $node (object), $depth (int, default 0)
--}}
@php $depth = $depth ?? 0; @endphp

<li class="lc-tree-item" id="lc-item-{{ $node->id }}" data-lc-item-id="{{ $node->id }}">

  <div class="lc-tree-row" style="--depth:{{ $depth }}">
