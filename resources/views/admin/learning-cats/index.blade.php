    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div class="lg:col-span-2">
            <x-admin.datatable-card
                ...
                empty-text="Use the form to add the first one.">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-xs text-[var(--color-mute)] space-y-1">
                                        <div>{{ $cat->created_at ? \Illuminate\Support\Carbon::parse($cat->created_at)->format('d M Y') : '—' }}</div>
            ...
            <form method="POST" action="{{ route('admin.learning-cats.store') }}" class="card p-5 lg:sticky lg:top-20">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="cat_icon" id="cat_icon" class="input" required maxlength="255"
                           value="{{ old('cat_icon', 'icon-folder') }}"
                           placeholder="icon-salad">
                    <p class="help">Lucide icon class (e.g. icon-salad). Preview below.</p>
