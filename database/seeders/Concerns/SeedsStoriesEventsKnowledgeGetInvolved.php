    ...
    private function eventsPageSections(): array
    {
        return [
            ...
            $this->section('board', 'board', [
                ...
                'subtitle' => 'Click a date on the calendar to highlight the matching event in the timeline. Filter the timeline by upcoming or past.',
                'calendar' => [
                    'month' => 'June 2026',
                    'event_count' => 5,
                    'days' => [
    ...
    private function getInvolvedPageSections(): array
    {
        return [
            $this->section('hero', 'hero', [
                ...
                'pathways' => [
                    ['num' => '01', 'label' => 'Individual', 'hint' => 'Skill-based'],
                    ['num' => '02', 'label' => 'Volunteer', 'hint' => 'Field support'],
                    ['num' => '03', 'label' => 'CSO/NGO', 'hint' => 'District work'],
                    ['num' => '04', 'label' => 'Firm/Organization', 'hint' => 'CSR & knowledge'],
                ],
            ], 3),
            $this->section('join', 'join', [
                'options' => [
                    ['title' => 'Individual', 'icon' => 'I', 'detail' => 'For professionals, communicators, researchers and practitioners who want to contribute skills.', 'items' => ['Training and capacity building', 'Communication design', 'Writing and documentation']],
                    ['title' => 'Volunteer', 'icon' => 'V', 'detail' => 'For people ready to support field outreach, local events, social media and community learning.', 'items' => ['Surveys and interviews', 'Photography and videos', 'Social media management']],
                    ['title' => 'CSO/NGO', 'icon' => 'C', 'detail' => 'For civil society groups working on health, nutrition, education, livelihoods or behaviour change.', 'items' => ['Campaign partnership', 'Resource sharing', 'District-level implementation']],
                    ['title' => 'Firm/Organization', 'icon' => 'F', 'detail' => 'For firms, institutions and organisations that want to support campaigns, research or capacity building.', 'items' => ['CSR collaboration', 'Knowledge support', 'Programme co-design']],
                ],
            ], 4),
