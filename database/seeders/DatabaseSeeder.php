...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            [
                'fname' => 'Anita', 'lname' => 'Author',
                'username' => 'anita.a',
                'email' => 'author@abc.in',
                'password' => Hash::make('abc@1234'),
                'image' => '',
                'bio' => 'Senior content author',
                'role' => 2,
                'type' => 'author',
                'date' => $now,
                'created_at' => $now, 'updated_at' => $now,
        ...
        $learningCats = [
            ...
            ['ODF+ and Hygiene', 'fa-solid fa-soap'],
            ['Child Health and Nutrition', 'fa-solid fa-baby'],
            ['Maternal Health and Nutrition', 'fa-solid fa-person-pregnant'],
            ['Education and Parental engagement', 'fa-solid fa-graduation-cap'],
            ['Life skills', 'fa-solid fa-seedling'],
            ['Mission Life', 'fa-solid fa-leaf'],
            ['Adolescent health and Nutrition', 'fa-solid fa-heart-pulse'],
            ['Mental Health', 'fa-solid fa-brain'],
            ['SBC', 'fa-solid fa-comments'],
        ];
