<?php return array (
  'hero' => '<div class="cmp-hero-deco" aria-hidden="true">
  ...
  'grid' => '<h2 id="cmp-grid-h" class="sr-only">Campaign cards</h2>
  ...
  'timelines' => '<div class="container-x">
