<?php return array (
  'hero' => '<div class="ab-hero-bg" aria-hidden="true">
  ...
  'vision_mission' => '<div class="ab-vm-head">
  ...
  'approach' => '<div class="ab-app-head">
    <span class="chapter"><b>04</b> · Our Core Approach</span>
  ...
  <ol class="ab-app-flow">
    <li class="ab-app-step" data-aos="fade-up">
      <span class="ab-app-num">01</span>
      <div class="ab-app-icon" aria-hidden="true">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12c0-5 4-9 9-9s9 4 9 9-4 9-9 9H3z"/><path d="M8 10h8M8 14h5"/></svg>
      </div>
      <h4>Understand local realities</h4>
      <p>Understanding local challenges, beliefs, and community needs before designing any communication.</p>
    </li>
    <li class="ab-app-step" data-aos="fade-up" data-aos-delay="80">
      <span class="ab-app-num">02</span>
      <div class="ab-app-icon" aria-hidden="true">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="14" rx="2"/><path d="M7 9h10M7 13h6"/></svg>
      </div>
      <h4>Use research and insight</h4>
      <p>Using research and real-world insights to design effective communication that responds to lived experience.</p>
    </li>
    <li class="ab-app-step" data-aos="fade-up" data-aos-delay="160">
      <span class="ab-app-num">03</span>
      <div class="ab-app-icon" aria-hidden="true">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M5 5l2 2M17 17l2 2M5 19l2-2M17 7l2-2"/></svg>
      </div>
      <h4>Create local messages</h4>
      <p>Creating culturally relevant messages in local contexts and languages so communication feels relatable.</p>
    </li>
    <li class="ab-app-step" data-aos="fade-up" data-aos-delay="240">
      <span class="ab-app-num">04</span>
      <div class="ab-app-icon" aria-hidden="true">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
      </div>
      <h4>Bring people together</h4>
      <p>Engaging communities, frontline workers, youth, media, and policymakers together on one platform.</p>
    </li>
    <li class="ab-app-step" data-aos="fade-up" data-aos-delay="320">
      <span class="ab-app-num">05</span>
      <div class="ab-app-icon" aria-hidden="true">
      ...
      <h4>Build lasting change</h4>
      <p>Promoting lasting behaviour change through participation, trust and shared ownership.</p>
    </li>
  </ol>',
  'voices' => '<div class="container-x">
  ...
  <div class="st-marquee" data-aos="fade-up" data-st-marquee>
    <div class="st-marquee-track">
      <figure class="st-quote-card">
        <blockquote>"Alliance for Behaviour Change is a meaningful initiative that brings together communities, youth, civil society, and institutions on a common platform for dialogue and action. By strengthening Social and Behaviour Change Communication, the alliance can help create informed communities, encourage positive practices, and ensure that important interventions reach and benefit every individual across Chhattisgarh."</blockquote>
        <figcaption>
          <b>Seema Kumar</b>
          <span>Chief, UNICEF Chhattisgarh</span>
        </figcaption>
      </figure>
      ...
      <figure class="st-quote-card" aria-hidden="true">
        <blockquote>"Alliance for Behaviour Change is a meaningful initiative that brings together communities, youth, civil society, and institutions on a common platform for dialogue and action. By strengthening Social and Behaviour Change Communication, the alliance can help create informed communities, encourage positive practices, and ensure that important interventions reach and benefit every individual across Chhattisgarh."</blockquote>
        <figcaption>
          <b>Seema Kumar</b>
          <span>Chief, UNICEF Chhattisgarh</span>
      ...
      <figure class="st-quote-card st-quote-card--ochre" aria-hidden="true">
        <blockquote>"Alliance for Behaviour Change is a shared platform for learning, collaboration, and collective action. By bringing together communities, youth, professionals, and institutions, it helps strengthen Social and Behaviour Change Communication through locally relevant and people-centered approaches. The alliance creates opportunities to exchange experiences, understand what works on the ground, and contribute towards lasting positive behaviour change across Chhattisgarh."</blockquote>
        <figcaption>
          <b>Abhishek Singh</b>
          <span>SBC Specialist, UNICEF Chhattisgarh</span>
  ...
  'partners' => '<div class="container-x">
