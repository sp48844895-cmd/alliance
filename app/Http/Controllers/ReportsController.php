...
class ReportsController extends Controller
{
    public function index()
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($hasFlipbook) {
                ...
                $previewUrl = $previewExists ? route('reports.preview', ['report' => $row->id]) : '#reports-title';
            }
        ...
        return view('reports.index', compact('metaTitle', 'metaDescription', 'pageTitle', 'pageLede', 'reports'));
    }
    ...
    public function preview(int $report)
    {
        ...
        return view('reports.preview', compact('reportTitle', 'reportType', 'previewSrc', 'reportCover', 'socialMeta'));
    }
    ...
    public function magazine(string $slug)
    {
        ...
        return view('reports.magazine', compact(
            'magazineTitle',
            'magazineType',
            'magazineSlug',
            'magazinePages',
