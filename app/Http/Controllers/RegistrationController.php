...
class RegistrationController extends Controller
{
    ...
    {
        return view('registrations.guest');
    }
    ...
    public function guestStore(Request $request)
    {
        ...
        return redirect()->route('register.guest')->with('register_toast', [
            'type' => 'success',
    ...
    public function internForm()
    {
        ...
        return view('registrations.intern', compact('domainAreas'));
    }
    ...
    public function internStore(Request $request)
    {
        ...
        return redirect()->route('register.intern')->with('register_toast', [
            'type' => 'success',
    ...
    public function fellowForm()
    {
        ...
        return view('registrations.fellow', compact('domainAreas'));
    }
    ...
    public function fellowStore(Request $request)
    {
        ...
        return redirect()->route('register.fellow')->with('register_toast', [
            'type' => 'success',
            'title' => 'Application received',
            'message' => 'Thank you for applying. We will review your application within 3 working days.',
        ]);
