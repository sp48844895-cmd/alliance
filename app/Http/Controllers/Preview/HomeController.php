    ...
    public function index()
    {
        ...
        foreach ($storyRows as $story) {
            ...
            $stories[] = [
                ...
                'url' => route('preview.stories.show', $slug),
        ...
        foreach ($eventRows as $index => $event) {
            ...
            $events[] = [
                ...
                'url' => route('preview.events.show', $slug),
        ...
        $storiesUrl = route('preview.stories');
        $eventsUrl = route('preview.events');
        ...
        $knowledgeHub = [
            ...
            'library_url' => route('preview.learning-corner'),
            'library_label' => $hubSection['library_label'] ?? 'Open the full library →',
            'resources' => [
                [
                    'url' => route('preview.learning-corner'),
                    'type' => 'Learning',
        ...
        $getInvolvedUrl = route('preview.get-involved');
        $getInvolved = [
        ...
        return view('preview::home.index', compact(
            'heroCarouselSlides',
            'intro',
            'homeSliderSlides',
            'programsUseSlider',
