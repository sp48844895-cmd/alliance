...
class LearningCornerController extends Controller
{
    public function index()
    {
        ...
        foreach ($allCats as $cat) {
            ...
            foreach ($allCats as $sub) {
                ...
                $children[] = [
                    ...
                    'count' => $subCount,
                    'url' => route('preview.learning-corner.sub', ['main' => $cat->id, 'sub' => $sub->id]),
                ];
            }
            ...
            $mainCategories[] = [
                ...
                'url' => route('preview.learning-corner.main', ['main' => $cat->id]),
            ];
        }
        ...
        return view('preview::learning-corner.index', compact(
            'metaTitle',
            'metaDescription',
            'mainCategories',
            'lcEyebrow',
    ...
    public function main(int $main)
    {
        ...
        foreach ($subs as $sub) {
            ...
            $subcategories[] = [
                ...
                'url' => route('preview.learning-corner.sub', ['main' => $main, 'sub' => $sub->id]),
            ];
        }
        ...
        return view('preview::learning-corner.subcategories', compact(
            'main',
            'subcategories',
            'lcEyebrow',
            'lcTitle',
    ...
    public function sub(int $main, int $sub)
    {
        ...
        return view('preview::learning-corner.resources', compact(
            'main',
            'sub',
            'resources',
            'lcEyebrow',
